...
OWNER_USERNAME = os.getenv("OWNER_USERNAME", "manisaia")
BOT_USERNAME = os.getenv("BOT_USERNAME", "zpv2musicbot")
...
UPSTREAM_REPO = os.getenv("UPSTREAM_REPO", "https://github.com/biduanx/zpxmusic")
UPSTREAM_BRANCH = os.getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = os.getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = os.getenv("SUPPORT_CHANNEL", "https://t.me/sukasukaaaya")
SUPPORT_GROUP = os.getenv("SUPPORT_GROUP", "https://t.me/logselpi")
